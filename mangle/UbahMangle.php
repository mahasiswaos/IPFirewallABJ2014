...
//$API->debug = TRUE;
$API->write("/ip/firewall/mangle/print", FALSE);
$API->write("?.id=" . $id);
$read = $API->read();
?>
<html>
    <head>
        ...
        <title>IP Firewall - Mangle Rules</title>
    </head>
    <body>
        <div class="container">
                    ...
                    <div class="panel-body">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <!--Form-->
                                <form class="form form-horizontal" action="index.php?file=SimpanUbahMangle" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <select class="form-control" id="chain" name="chain">
                                                ...
                                                <option value="postrouting" <?php
                                                if ($chain == 'postrouting') {
                                                    echo "selected";
                                                }
                                                ?>  >postrouting</option>
                                                <option value="prerouting" <?php
                                                if ($chain == 'prerouting') {
                                                    echo "selected";
                                                }
                                                ?>  >prerouting</option>
