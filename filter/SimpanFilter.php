        ...
        <div class="container">
            ...
            <div class="col-sm-offset-3 col-sm-6">
                <div class="alert alert-danger fade in">
                    ...
                    <br>
                    <p>Sistem Gagal menambah Filter Rules! silakan coba kembali.</p>
                    <p>Error dengan Pesan : <?php echo $baca['!trap'][0]['message'] ?></p>
                    <br>
                    <p>
                        <a href="index.php?file=ViewFilter"> <button type="button" class="btn btn-danger">Kembali</button></a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="col-sm-offset-3 col-sm-6">
                <div class="alert alert-success fade in" >
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><span class="glyphicon glyphicon-remove-circle"></span></button>
                    <h4><b>Berhasil Tambah Filter Rules !!</b></h4>
                    <br>
                    <p>Sistem berhasil menambah Filter Rules!</p>
                    <br>
                    <p>
                        <a href="index.php?file=ViewFilter"><button type="button" class="btn btn-success" >Oke</button></a>
                    </p>
                </div>
            </div>
        </div>
